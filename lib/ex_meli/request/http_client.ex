defmodule ExMeli.Request.HttpClient do
  @moduledoc """
  Specifies expected behaviour of an http client

  ExMeli allows you to use your http client of choice, provided that
  ...
  In your config you would do:
      ...
      config :ex_aws,
        http_client: ExMeli.Request.HTTPotion

      defmodule ExMeli.Request.HTTPotion do
        @behaviour ExMeli.Request.HttpClient
